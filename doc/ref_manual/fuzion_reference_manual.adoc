...
The Unicoe code points of the input data are grouped into lexical tokens.  The
...
[none]  // [none] means no bullet points
...
white space often plays an important role in speratating tokens such as a
