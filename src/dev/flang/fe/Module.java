...
public abstract class Module extends ANY
{
                           ...
                           AbstractFeature f)
  {
    ...
    // if (TypeInScope(pos.pos()._sourceFile, f))
    //   {
        set.put(fn, f);
    // }
  }
   ...
   * @return
   */
  protected boolean FeatureInScope(SourceFile usedIn, AbstractFeature af)
  {
   ...
   * @return
   */
  protected boolean TypeInScope(SourceFile usedIn, AbstractFeature af)
  {
    var m = (af instanceof LibraryFeature lf) ? lf._libModule : this;
    var definedIn = af.pos()._sourceFile;
    var v = af.visibility();
