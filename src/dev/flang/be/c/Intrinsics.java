...
public class Intrinsics extends ANY
{
  ...
  static
  {
    ...
    put("f32.type.equal"          ,
        "f64.type.equal"          , (c,cl,outer,in) -> outer.eq(A0).cond(c._names.FZ_TRUE, c._names.FZ_FALSE).ret());
    put("f32.type.lower_than_or_equal"         ,
        "f64.type.lower_than_or_equal"         , (c,cl,outer,in) -> outer.le(A0).cond(c._names.FZ_TRUE, c._names.FZ_FALSE).ret());
