...
public class GeneratingFUIR extends FUIR
{
  ...
  static
  {
    ...
    _removedIntrinsics_.put
      ("autogenerated_code_for_effect_types_fold",
       (call, currentClazz, fuir) ->
       {
         fuir._clazzesWhoseCodeDependsOnInstatedEffectTypes.add(currentClazz);
         ...
         return codeForTypeFold(call,
                                currentClazz,
                                new List<>
                                  (fuir._instatedEffectTypes.stream()
   ...
   * `autogenerated_code_for_Open_Types_fold` and
   * `autogenerated_code_for_effect_types_fold` to create the actual inline
   * code.
   *
   * @param call to the `autogenerated_code_for...` method we are creating code
   * for.
   *
   ...
   */
  final TreeSet<Integer>   _instatedEffectTypes = new TreeSet<>();


  /**
   * All the clazzes whose code depends on _instatedEffectTypes. Their code
   * must be re-generated in case new effect clazzes are found to be instated.
   */
  final TreeSet<Clazz>     _clazzesWhoseCodeDependsOnInstatedEffectTypes = new TreeSet<>();
   ...
   * `effect_types.autogenerated_code_for_effect_types_fold`.
   *
   * In case a new type is added, all the code that was generated for
   * `effect_types.autogenerated_code_for_effect_types_fold` will be deleted.
   */
  @Override
