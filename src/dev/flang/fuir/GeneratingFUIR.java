    ...
    _removedIntrinsics_.put
      ("autogenerated_code_for_Values_Of_Open_Type_fold",
       (call, currentClazz) ->
       {
         ...
         var baseName = FuzionConstants.extractBaseNameFromValuesAsOpenTypeName(currentClazz._outer.feature().featureName().baseName());
    ...
    _removedIntrinsics_.put
      ("autogenerated_code_for_Values_Of_Open_Type_zip",
       (call, currentClazz) ->
       {
         ...
         var args = currentClazz._outer._outer.argumentFields();
         var fields = Stream.of(args).filter(c -> c.feature().isOpenGenericField()
                                             /* NYI: && c.feature().featureName().baseName().equals(baseName) */
                                             ).toList();
