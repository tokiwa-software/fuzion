...
public class DFA extends ANY
{
  ...
  static
  {
    ...
    put("fuzion.std.fileio.open_source"  , cl -> new NumericValue(cl._dfa, cl._dfa._fuir.clazzResultClazz(cl._cc)) );
    put("fuzion.std.fileio.close_source" , cl -> cl._dfa._bool );
