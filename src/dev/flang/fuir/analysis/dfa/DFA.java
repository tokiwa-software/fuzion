...
public class DFA extends ANY
{
  ...
  static
  {
    ...
    put("fuzion.std.fileio.on_open_c"    , cl -> Value.UNIT ); // NYI : manipulation of an array passed as argument needs to be tracked and recorded
    put("fuzion.std.fileio.on_close_c"   , cl -> cl._dfa._bool );
    put("fuzion.std.fileio.get_error_c"  , cl -> new NumericValue(cl._dfa, cl._dfa._fuir.clazzResultClazz(cl._cc)) );
