    ...
    if (true)  // NYI: This syntactic sugar should not be resolved if this array is a compile-time constant
      {
        ...
        var fuzionT      = new Type("fuzion", Type.NONE, null);
        var sysT         = new Type("sys"   , Type.NONE, fuzionT);
        var sysArrayT    = new Type("internal_array", eT, sysT);
