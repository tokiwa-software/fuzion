...
public class ParseUnicodeData extends ANY
{
  ...
  {
    say("  /* Unicode data from '" + _name + "' last modified '" + _lastModified + "' */");
    ...
    say("  static final String[] _CATEGORIES_ = new String[] {" + table(c, x -> "\"" + x + "\"") + "\n  };");
  }
  ...
  private void printFuzion()
  {
    ...
    say("# DO NOT EDIT - AUTOMATICALLY GENERATED");
    say("# GENERATED BY ./src/dev/flang/util/unicode/ParseUnicodeData.java");
    say("# Unicode data from '" + _name + "' last modified '" + _lastModified + "'");
