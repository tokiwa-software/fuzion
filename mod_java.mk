...
$(MOD_JAVA_DESKTOP_FZ_FILES): $(FZJAVA) $(MOD_JAVA_BASE) $(MOD_JAVA_DATATRANSFER)
	rm -rf $(@D)
	mkdir -p $(@D)
	$(FZJAVA) java.desktop -to=$(@D) -modules=java.base,java.xml,java.datatransfer
# NYI: CLEANUP: see #462: manually move these features to the main directory
# since otherwise they would not be found automatically.
