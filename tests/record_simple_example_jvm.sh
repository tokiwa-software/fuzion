...
if [ -f "$2".skip ]; then
    ...
    (FUZION_DISABLE_ANSI_ESCAPES=true $1 -XmaxErrors=-1 -jvm ${FUZION_JVM_BACKEND_OPTIONS:+ $FUZION_JVM_BACKEND_OPTIONS} "$2" >"$2".expected_out_jvm 2>"$2".expected_err_jvm) || true
