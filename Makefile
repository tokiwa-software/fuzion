...
MOD_TRANSDUCER        = $(BUILD_DIR)/modules/transducer.fum
...
$(MOD_TRANSDUCER): $(MOD_BASE) $(BUILD_DIR)/bin/fz $(FZ_SRC)/modules/transducer/src/transducer.fz
	mkdir -p $(@D)
	$(BUILD_DIR)/bin/fz -sourceDirs=$(FZ_SRC)/modules/transducer/src -saveLib=$@
